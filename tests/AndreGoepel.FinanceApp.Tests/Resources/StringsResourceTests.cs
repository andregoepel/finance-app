...
public sealed class StringsResourceTests
{
    ...
    [InlineData("en", "Nav.Cash", "Cash")]
    [InlineData("de", "Nav.Cash", "Bargeld")]
    [InlineData("en", "Enum.SyncMethod.Manual", "Manual")]
    ...
    [InlineData("de", "Review.ClearSelection", "Auswahl aufheben")]
    ...
    [InlineData("en", "Import.PageSizeText", "Rows per page")]
    [InlineData("de", "Import.PageSizeText", "Zeilen pro Seite")]
    [InlineData("en", "Import.NoHistory", "No imports for this account yet.")]
    [InlineData("de", "Import.NoHistory", "Für dieses Konto gibt es noch keine Importe.")]
    ...
    [InlineData("en", "Dashboard.ActualNetWorth", "Actual")]
    [InlineData("de", "Dashboard.ActualNetWorth", "Tatsächlich")]
    [InlineData("en", "Dashboard.ForecastNetWorth", "Forecast")]
    [InlineData("de", "Dashboard.ForecastNetWorth", "Prognose")]
    ...
    [InlineData("en", "Dashboard.NoBudgetsSet", "No budgets or planned expenses —")]
    [InlineData("de", "Dashboard.NoBudgetsSet", "Keine Budgets oder geplanten Ausgaben —")]
    [InlineData("en", "Dashboard.BudgetForecast", "{0} spent + {1} planned / {2} budget")]
    [InlineData("de", "Dashboard.BudgetForecast", "{0} ausgegeben + {1} geplant / {2} Budget")]
    [InlineData("en", "Dashboard.PlannedOnly", "{0} planned")]
    [InlineData("de", "Dashboard.PlannedOnly", "{0} geplant")]
    [InlineData("en", "Planning.Unallocated", "Unallocated")]
    [InlineData("de", "Planning.Unallocated", "Nicht zugeordnet")]
    ...
    [InlineData("en", "Budgets.AddTitle", "Add budget")]
    [InlineData("de", "Budgets.AddTitle", "Budget hinzufügen")]
    [InlineData("en", "Budgets.EditTitle", "Edit budget")]
    [InlineData("de", "Budgets.EditTitle", "Budget bearbeiten")]
