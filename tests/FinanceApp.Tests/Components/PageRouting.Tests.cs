using FinanceApp.Components.Import.Pages;
using FinanceApp.Components.Settings.Pages;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Components;
using TransactionsPage = FinanceApp.Components.Transactions.Pages.Transactions;

namespace FinanceApp.Tests.Components;
